...
public  class ChartShape 
{
	 ...
	 * 线的粗细(最细)
	 */
	public static float LINE_TINY = 0.7f;

	/**
	 * 线的粗细(细)
	 */
	public static float LINE_THIN = 1.0f;

	/**
	 * 线的粗细(一般)
	 */
	public static float LINE_NORMAL = 1.5f;

	/**
	 * 线的粗细(宽)
	 */
	public static float LINE_WIDE = 2.0f;

	/**
	 * 线的粗细(最宽)
	 */
	public static float LINE_BOLD = 3.0f;
